...
# Massive search term list for building a large pool
_SEARCH_TERMS = [
    # Games
    "csgo", "dota", "dota2", "gta", "minecraft", "rust", "tf2", "halflife",
    "portal", "left4dead", "garry", "terraria", "ark", "pubg", "fortnite",
    "apex", "valorant", "overwatch", "league", "warcraft", "diablo",
    "starcraft", "halo", "destiny", "fallout", "skyrim", "witcher",
    "cyberpunk", "elden", "dark souls", "resident evil", "silent hill",
    "battlefield", "call of duty", "cod", "far cry", "assassin",
    "borderlands", "bioshock", "doom", "quake", "unreal",
    "civilization", "total war", "age of empires", "europa",
    "crusader kings", "stellaris", "factorio", "rimworld",
    "stardew", "animal crossing", "sims", "cities skylines",
    "kerbal", "no man sky", "subnautica", "satisfactory",
    "deep rock", "phasmophobia", "among us", "fall guys",
    "rocket league", "rainbow six", "escape from tarkov",
    "path of exile", "warframe", "payday", "killing floor",
    "arma", "dayz", "squad", "insurgency", "hell let loose",
    "hunt showdown", "dead by daylight", "sea of thieves",
    "monster hunter", "final fantasy", "dragon quest", "persona",
    "yakuza", "metal gear", "devil may cry", "god of war",
    "horizon", "spider man", "batman", "genshin", "honkai",
    # Genres
    "gaming", "fps", "rpg", "mmorpg", "moba", "rts", "strategy",
    "survival", "horror", "action", "adventure", "puzzle", "racing",
    "sports", "fighting", "platformer", "sandbox", "simulation",
    "roguelike", "roguelite", "metroidvania", "souls like",
    "battle royale", "tower defense", "card game", "visual novel",
    "jrpg", "crpg", "arpg", "tactical", "stealth", "shooter",
    "open world", "co-op", "coop", "multiplayer", "singleplayer",
    "retro", "pixel", "2d", "3d", "vr", "early access",
    # Community
    "steam", "trade", "trading", "market", "community", "group",
    "clan", "guild", "team", "esports", "competitive", "casual",
    "friends", "social", "chat", "forum", "discussion",
    "memes", "funny", "art", "creative", "modding", "workshop",
    "speedrun", "achievement", "review", "guide", "tutorial",
    "giveaway", "free", "sale", "deal", "bundle", "key",
    # Misc
    "anime", "manga", "music", "movie", "film", "tv", "netflix",
    "tech", "programming", "linux", "windows", "hardware",
    "nvidia", "amd", "intel", "pc", "laptop", "build",
    "streamer", "youtube", "twitch", "content creator",
    "english", "russian", "german", "french", "spanish",
    "portuguese", "chinese", "japanese", "korean", "turkish",
    "polish", "italian", "dutch", "swedish", "czech",
    "ukrainian", "brazilian", "australian", "canadian",
    "european", "asian", "american", "international",
    "news", "politics", "science", "history", "nature",
    "photography", "design", "comics", "books", "education",
]
